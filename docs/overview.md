...
Usually no. It works automatically once installed. You will see its effect in the choice of blocks available when you edit a page.

## Where it shows up

In **Layout Builder's** widget panel, as the blocks you can drag onto a page.
